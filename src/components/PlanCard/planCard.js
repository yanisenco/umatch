...
const PlanCard = () => {
    ...
    return (
        <div className="w-[15%] bg-input-color rounded-lg shadow-lg">
            <div className="flex h-[50px] bg-yellow rounded-t-lg items-center" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 calc(100% - 10px))'}}>
                <h3 className="absolute ml-2">dssd</h3>
